...
\item If you don't have an GitHub account, please, do the
  \href{https://guides.github.com/activities/hello-world/}{the Hello
    World guide at GitHub} and create one. \footnote{Notice that
...
\item Make a fork of the
  \href{https://github.com/<orgainization\_name>/<repo\_name>}{<repo\_name>}
...
\end{verbatim}        
  ...
  the <repo\_name>. Notice, that the action of clonning (not forking) the
  <repo\_name> is a waste of time because you cannot contribute directly
...
\item Add the
  ...
  \begin{lstlisting}[language=bash]
    git remote add upstream git@github.com:<orgainization_name>/<repo_name>.git
  \end{lstlisting}
...
\begin{verbatim}
origin   git@github.com:you_at_GitHub/<repo\_name>.git (fetch)
origin   git@github.com:you_at_GitHub/<repo\_name>.git (push)
upstream git@github.com:<orgainization_name>/<repo\_name>.git (fetch)
upstream git@github.com:<orgainization_name>/<repo\_name>.git (push)
\end{verbatim}
